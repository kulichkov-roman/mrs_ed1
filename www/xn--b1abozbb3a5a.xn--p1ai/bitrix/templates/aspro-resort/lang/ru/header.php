...
$MESS["ERROR_INCLUDE_MODULE_RESORT_TITLE"] = 'Ошибка подключения модуля &laquo;Аспро: Курорт - сайт базы отдыха, санатория, гостиницы&raquo;';
$MESS["ERROR_INCLUDE_MODULE_RESORT_TEXT"] = 'Ошибка подключения модуля &laquo;Аспро: Курорт - сайт базы отдыха, санатория, гостиницы&raquo;.<br />Пожалуйста установите модуль и повторите попытку';
