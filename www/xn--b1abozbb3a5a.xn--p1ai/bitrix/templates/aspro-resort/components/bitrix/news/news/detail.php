...
<?
// get element
$arItemFilter = CResort::GetCurrentElementFilter($arResult['VARIABLES'], $arParams);
...
<?else:?>
			...
			<div class="wraps nomargin">
				...
				<?$APPLICATION->IncludeComponent(
					...
					Array(
						...
						"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["aspro_resort_catalog"]["aspro_resort_catalog"][0],
						"NEWS_COUNT" => "20",
		...
		<?if(in_array('LINK_STUDY', $arParams['DETAIL_PROPERTY_CODE']) && $arElement['PROPERTY_LINK_STUDY_VALUE']):?>
			<div class="wraps nomargin">				
				...
				<?$APPLICATION->IncludeComponent(
					...
					array(
						"IBLOCK_TYPE" => "aspro_resort_catalog",
						"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["aspro_resort_catalog"]["aspro_resort_study"][0],
						"NEWS_COUNT" => "20",
						"SORT_BY1" => "ACTIVE_FROM",
						"SORT_ORDER1" => "DESC",
						"SORT_BY2" => "SORT",
	...
	if(is_array($arElement['IBLOCK_SECTION_ID']) && count($arElement['IBLOCK_SECTION_ID']) > 1){
		CResort::CheckAdditionalChainInMultiLevel($arResult, $arParams, $arElement);
	}
	?>
<?endif;?>
