...
$arItemFilter = CResort::GetCurrentSectionElementFilter($arResult["VARIABLES"], $arParams);
$arSectionFilter = CResort::GetCurrentSectionFilter($arResult["VARIABLES"], $arParams);
...
$arSubSectionFilter = CResort::GetCurrentSectionSubSectionFilter($arResult["VARIABLES"], $arParams, $arSection['ID']);
